...
if($_SESSION["type"] == "Admin" OR $_SESSION["type"] == "Manager") {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Add actLog
        global $actLog; $actLog->add('MyWebAPI',$userId,1,'{"Action":"Change Status","Status":"'.$status.'"}');
