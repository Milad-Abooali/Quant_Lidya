...
$columns = array(
	...
	array( 'db' => 'MT4_TRADES.OPEN_TIME', 'dt' => 8, 'field' => 'OPEN_TIME', 'as' => 'OPEN_TIME' ),
	array( 'db' => 'MT4_TRADES.CLOSE_TIME', 'dt' => 9, 'field' => 'CLOSE_TIME', 'as' => 'CLOSE_TIME' ),
	array( 'db' => 'MT4_TRADES.SWAPS', 'dt' => 10, 'field' => 'SWAPS', 'formatter' => function( $d, $row ){ 
	    $swap = number_format($d,2);
	    return $swap;
	    
	}, 'as' => 'SWAPS' ),
	array( 'db' => 'MT4_TRADES.PROFIT', 'dt' => 11, 'field' => 'PROFIT', 'formatter' => function( $d, $row ){ 
	    $profit = number_format($d,2);
	    return $profit;
	    
	}, 'as' => 'PROFIT' ),
	array( 'db' => 'CRMRet.RetentionOwnerName', 'dt' => 12, 'field' => 'RetentionOwnerName', 'as' => 'RetentionOwnerName' ),
);
...
$extraWhere = 'MT4_USERS.AGENT_ACCOUNT <> "1" AND MT4_TRADES.CMD < 2 AND MT4_TRADES.CLOSE_TIME <> "1970-01-01 00:00:00" AND MT4_USERS.GROUP IN ("'.$array.'") AND MT4_TRADES.CLOSE_TIME BETWEEN "'.$startTime.'" AND "'.$endTime.'"';
