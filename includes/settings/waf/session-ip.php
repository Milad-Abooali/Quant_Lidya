...
<section class="<?= $href ?>">
    ...
    <input id="searchVal" type="text" placeholder="IP: 255.255.255.255" value="<?= ($search_ip) ?>">
    <button id="goSearch" class="btn btn-primary btn-sm">Search</button>
    ...
    <h6 class="text-center">Sessions by IP  (<?= $search_ip ?>)</h6>
    <div>
